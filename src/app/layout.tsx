        ...
        <div className="flex flex-col min-h-screen">
          ...
          <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2">
            <a
              ...
              className="rounded-full bg-green-500 p-4 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-green-600"
            ...
            <a
              ...
              className="rounded-full bg-blue-500 p-4 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-blue-600"
              aria-label="Call Us"
            >
